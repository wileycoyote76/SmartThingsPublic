...
metadata {
	definition (name: "GE Portable Smart Motion Sensor - updated", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.motion") {
	...
	simulator {
        ...
        input "parameterEighteen", "number", title: "PIR Timeout Duration (minutes): default=4, 1-60",  defaultValue: 4, range: "1..60", required: false, displayDuringSetup: true
